...
export default function Editor(): JSX.Element {
  ...
  return (
    <div className="app-container">
      <div className="header-wrapper">
        <div className="header-top-row">
          ...
          <div className="header-actions">
            <i className="icon-history" title="Last edit was seconds ago" />
            <button className="share-button">
              <i className="icon share" style={{ display: 'inline-block', width: 16, height: 16, marginRight: 8, backgroundImage: 'url(images/icons/lock-fill.svg)', backgroundSize: 'contain' }} />
              Share
            </button>
            <div style={{ width: 32, height: 32, borderRadius: 16, backgroundColor: '#f06292', marginLeft: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}>U</div>
          </div>
        </div>
      ...
      <div className="document-viewport" style={{ display: 'flex', justifyContent: 'center', position: 'relative' }}>
        <div className="vertical-ruler-section" style={{ position: 'absolute', left: 0, top: 0, bottom: 0, marginTop: '40px', zIndex: 10 }}>
          <VerticalRuler />
        </div>
